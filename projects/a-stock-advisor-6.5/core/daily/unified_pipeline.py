...
class UnifiedPipeline:
    ...
    def _step_data_update(self) -> Dict[str, Any]:
        ...
        result = updater.incremental_update(
            stock_list=stock_list, data_types=["daily"], parallel_workers=4
        )
    ...
    def _step_alpha_generate(self) -> Dict[str, Any]:
        ...
        if not combination_result.success:
            ...
            return {
                ...
                "quality_metrics": {"total_stocks": 0, "alpha_coverage": 0.0},
            }
            ...
            "positions": [
                {
                    ...
                    "shares": int(total_value * target_weights.get(code, 0) / 10),
                    "market_value": total_value * target_weights.get(code, 0),
                    "daily_return": 0,
                    "contribution": 0,
                }
